  ...
  theme: {
    extend: {
      backgroundImage: {
        ...
        'dark-gradient': 'linear-gradient(135deg, #0a0b1e 0%, #1a1b23 50%, #2a2b33 100%)',
        'cyber-gradient': 'linear-gradient(45deg, #00f5ff 0%, #0080ff 50%, #8000ff 100%)',
      },
      borderRadius: {
        lg: 'var(--radius)',
      ...
      animation: {
        ...
        'magnetic': 'magnetic 0.1s ease-out',
      },
    },
  },
